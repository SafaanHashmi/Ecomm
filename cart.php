                        ...
                        <form action="#">               
                            <div class="table-content table-responsive">
                                <table>
									...
									?>
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$pimage?>" /></a></td>
                                            <td class="product-name"><a href="#"><?php echo $pname ?></a>
                                                <ul  class="pro__prize">
                                                    <li class="old__prize"><?php echo $pprice ?></li>
                                                    <li><?php echo $pmrp ?></li>
                                                </ul>
                                            </td>
                                            <td class="product-price"><span class="amount"><?php echo $pmrp ?></span></td>
                                            ...
                                            <td class="product-subtotal"><?php echo $qty*$pmrp?></td>
